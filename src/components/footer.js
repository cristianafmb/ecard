...
import { Row, Col, Modal, Link } from 'react-bootstrap'
                        ...
                        {data.politicas.map((pol, j) => (
                            <>
                                <Col className="no-space-col-left mt-3">
                                    <btn className="no-text-decoration" onClick={() => handleShow(pol.title)} key={"politica" + j}>
                                        <p className="white details-x-small mMedium text-uppercase mb-0 cursor-pointer">{pol.title}</p>
                                    </btn>
